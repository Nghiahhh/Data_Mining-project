...
public class Data_MiningProject {
    ...
    // Hàm tính mean cho từng thuộc tính (cột)
    ...
    // Thay thế outlier bằng mean cho train
        ...
        for (int i = 0; i < data.numInstances(); i++) {
            ...
            for (int attrIndex : thresholds.bounds.keySet()) {
                ...
                if (val < bound[0] || val > bound[1]) {
                    // Thay thế outlier bằng mean của cột
    ...
    // Thay thế outlier bằng mean cho test
    ...
    public static void saveDataYToArff(String inputPathY, String outputArffY) {
        try {
            ...
            System.out.println("Save data: " + outputArffY);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void saveDataXToArff(String inputPathX, String outputArffX) {
        try {
            ...
            System.out.println("Save data: " + outputArffX);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
